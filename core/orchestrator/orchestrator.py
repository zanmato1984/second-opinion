...
from core.selector.selector import LLMReviewerSelector, expand_collections
...
class Orchestrator:
    ...
    def run(
        ...
        selector = LLMReviewerSelector(self._config.selector_backend)
        ...
        final_reviewer = LLMFinalReviewer(self._config.final_backend)
